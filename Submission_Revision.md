...
My lowest score lies in the "accuracy and completion of markdown code section." The main piece of feedback here was in regards to my project not being properly encoded in markdown. Unfortunately, you cannot use embeds in GitHub markdown, so providing the Neocities link where my project is hosted was the only realistic way my project could be viewed. That being said, I most definitely could have encoded my reflection blog post in markdown. I had thought about doing so initially, but because of the piece being over 2000 words (and several images) I was worried that it would would cause clutter, and be a labour intensive provess for the editorial team. This is why I decided to simply link the blog post in my submission. I remain confident in my decision to take this approach, so I won't be making any modifications at this time. 

![CFP2025](https://raw.githubusercontent.com/melisstuniewicz9/cts4000/refs/heads/main/SS2.png)

I wanted to quickly address my citations list. From my understanding, the use of footnotes was a suggestion, and not a requirment. To be fully transparent, I am not too confident in Chicago style citations, and have mostly worked with APA format during my undergraduate degree. I did make an effort to change my APA bibliography into a Chicago Style one prior to sending it over to Gabby, but I did not include footnotes due to lack of experience. This was definitely important for me to hear, as I likely should demonstrate competency in MLA, APA and Chicago style, so I will make sure to experiment with this citation method in the future. I'm thankful this was brought to my attention (especially since I am keen on pursuing graduate studies.) Gabby also noted that the header image that I inserted of my website banner, was not available for her to view as I had not shared the entire repository in which the image was stored with her alongside my submission file. That was most certianly an oversight on my part! The image links provided contain the paths to the raw image file, so viewing them should not be an issue!

While Gabby mentioned that my metadata was done well, I received feedback from the editorial team that I should include a short biography within my submission. I had left this out initially because I was unsure whether my project would be selected, and I did not want to overload the submission with unnecessary detail until I knew it would be worthwhile. I will update my submission review to include some basic information about myself, such as my program, my interest in the intersection of scholarly research and creativity, and my passion for experiencing learning through non-traditional, more immersive digital formats.

Overall, this was a valuable learning experience, and having my peers review my work authentically helped me present the strongest version of my project!
